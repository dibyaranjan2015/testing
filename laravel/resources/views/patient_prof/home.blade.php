...
div.portfoliocard div.right_col{s
                  ...
                  <section class="light-gray-bg pv-30 clearfix">
                        <div class = "col-md-8 col-md-offset-2">
                                    ...
                                    <div class="left_col col-md-3">
                                          <img class="img-responsive" src="{!! '/uploads/'.$user->image !!}" style="margin: 20%;" width="60%">
                                    </div>
                                    <div class="right_col col-md-9">
                                    ...
                                    <div class="col-md-11">
                                          <ul class="contact_information">
                                                <li>BLOODGROUP = {{$user->blood_group}}</li>
                                                <li>AGE = {{$user->age}}</li>
                                                <li>GENDER = {{$user->gender}}</li>
                                                <li>ADDRESS = {{$user->str_address}}</li>
                                                <li style="margin-left: 17.8%">{{$user->city}}</li>
                                                <li style="margin-left: 17.8%">{{$user->district}}</li>
                                                <li style="margin-left: 17.8%">{{$user->state}}</li>
                                                <li style="margin-left: 17.8%">{{$user->country}}</li>
                                                <li>EMAIL ADDRESS = {{$user1->email}}</li>
                                                <li>PHONE NUMBER = {{$user1->mob}}</li>
                                          </ul>
                                    </div>
                                    </div>
                                    </div>
